...
use crate::{INSCopying, INSFastEnumeration, INSMutableCopying, INSObject, NSEnumerator};
...
pub trait INSMutableArray: INSArray {
    ...
    {
        unsafe extern "C" fn compare_with_closure<T, F>(
            obj1: &T,
            obj2: &T,
            compare: &mut F,
        ) -> NSComparisonResult
        ...
        let f: unsafe extern "C" fn(&Self::Item, &Self::Item, &mut F) -> NSComparisonResult =
